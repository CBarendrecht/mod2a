...
for wis = [0,1] %kan ook gebruikt worden voor onderzoek invloed random 
...
%hold on;
scatter(DATA(1:101,13),DATA(1:101,20),25,[0,0,1],'p','filled');
hold on;
scatter(DATA(102:202,13),DATA(102:202,20),25,[1,0,1],'p','filled');
%hold on;
...
%hold on;
scatter(DATA(1:101,13),DATA(1:101,26),25,[0,0,1],'p','filled');
hold on;
scatter(DATA(102:202,13),DATA(102:202,26),25,[1,0,1],'p','filled');
%hold on;
...
%hold on;
scatter(DATA(1:101,13),GMGMH(max(DATA(:,21)),1:101),25,[0,0,1],'p','filled');
hold on;
scatter(DATA(102:202,13),GMGMH(max(DATA(:,21)),102:202),25,[1,0,1],'p','filled');
%hold on;
