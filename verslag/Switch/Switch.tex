...
From figure \ref{fig:aantgen}, we deduced that on average, a board reaches equilibrium in only a few generations. This however decreases even more drastically when switching goes in effect:
...
From figure \ref{fig:AantGenS}, we observed that the average generations is nearly the same for HR 0.6 until 1. 
