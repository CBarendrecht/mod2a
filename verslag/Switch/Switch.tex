...
To test whether it is justified to make this claim, we will conduct the \(t\)-test as described in section\ref{subsec:avegensw}. We will test if the segregation time at \(60\%\) and \(75\%\) have the same mean value.
In order to test this, we ran 5000 simulations for both \(60\%\) and \(75\%\).