...
\newpage
For this project, we focus on the following main questions:
\begin{enumerate}
	...
	\item What can we say about the model if we include the ability to switch type?
	How does this affect the number of generations, the probability distribution of the number of generation and the other questions posed above?
\end{enumerate}
