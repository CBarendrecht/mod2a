...
In the basic model this is not always true however. 
Even though equilibrium is nearly alays reached in finite time, there exists cases in which allow a periodic solution. 
One example of any such scenario is given below:
...
After the first move, both $37$ and $38$ will gain happiness, but as \(37\) moves away, $38$ will loses all of his/her happiness. 
