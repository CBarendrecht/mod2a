...
Furthermore, the basic model uses the second order neighbourhood, The maximum number of neighbours a person can have is 8. The model however can be changed by preference in several ways.\\
\\
...
As a result, all criminals should end up living together after segregation.
...
In this case, equilibrium is reached, because every unhappy individual cannot move to another placen, since every empty location is in the neighbourhood of a criminal.
