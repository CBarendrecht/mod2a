...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{happy_segr_60_80_100.pdf}
    \caption{For each $HR = 0,0.025,...,1$, the fraction of the simulations in which 60$\%$,80$\%$ and 100$\%$ is reached.}
    \label{fig:happyseg4b}
\end{figure}